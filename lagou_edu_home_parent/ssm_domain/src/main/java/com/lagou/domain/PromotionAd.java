...
public class PromotionAd implements Serializable {
    ...
    public PromotionAd(Integer id, String name, Integer spaceId, String keyword, String htmlContent,
                       String text, String link, Date startTime, Date endTime, Date createTime, Date updateTime,
                       Integer status, Integer priority, String img, PromotionSpace promotionSpace) {
        this.id = id;
        this.name = name;
