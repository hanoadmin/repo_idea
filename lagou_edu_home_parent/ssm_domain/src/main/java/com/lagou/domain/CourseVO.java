...
public class CourseVO {
    ...
    public CourseVO(Integer id, String courseName, String brief, double price, String priceTag, double discounts,
                    String discountsTag, String courseDescriptionMarkDown, String courseDescription,
                    String courseImgUrl, int isNew, String isNewDes, int lastOperatorId, int isDel, int totalDuration,
                    String courseListImg, int status, int sortNum, String previewFirstField, String previewSecondField,
                    int sales, String teacherName, String position, String description) {
        this.id = id;
